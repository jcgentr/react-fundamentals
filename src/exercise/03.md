...
Babel is written in JS, that's why we can run it in the browser and get hot
reloading.

Statements or code blocks can't be in JSX interpolated areas since it gets
compiled down to an argument in the React.createElement function call. Can use
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=03%3A%20Using%20JSX&em=jcgentr%40clemson.edu).
